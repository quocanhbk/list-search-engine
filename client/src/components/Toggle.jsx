...
const StyleInput = styled.input`
  ...
  &:checked ~ .toggle-switch {
    transition: 0.4s;
    background: ${(props) =>
      props.displayMode === "disabled"
        ? props.theme.color.fill.disabled
...
const Toggle = (props) => {
  ...
  return (
    <LabelToggle
      {...props}
      displayMode={props.disabled ? "disabled" : props.displayMode}
    >
      <ToggleSpan>
        <StyleInput
          displayMode={props.disabled ? "disabled" : props.displayMode}
      ...
      <StyleName displayMode={props.disabled ? "disabled" : props.displayMode}>
        {props.children}
      </StyleName>
    </LabelToggle>
  );
