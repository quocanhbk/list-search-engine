    ...
    return (
        <CardWrapper selected={selected} onClick={onClick}>
            ...
            <InformationZone>
                ...
                <DateAndProgress>
                    <Progress progress={progress} onClick={(e) => {e.stopPropagation(); filterContext.addFilter("progress", progress)}}/>
                    <DueDate dateString={dueDate} progress={progress} onClick={(e) => {e.stopPropagation();filterContext.addFilter("dueDate", dueDate)}}/>
                </DateAndProgress>
                <Category>
                    {category.map(item => <Tag key={item} text={item} onClick={(e) => {e.stopPropagation();filterContext.addFilter("category", item)}}/>)}
                </Category>
            </InformationZone>
        </CardWrapper>
    );
